...
//68/98/178
#define BAR_SEL_COLOR [UIColor colorWithRed:68.0f/255.0f green:98.0f/255.0f blue:178.0f/255.0f alpha:0.6]

//Editable constants
static const float VALUE_HEIGHT = 65.0;
static const float SAVE_AREA_HEIGHT = 70.0;
static const float SAVE_AREA_MARGIN_TOP = 50.0;
...
@property (nonatomic, strong) SHRectangleButton *saveButton;
...
- (void)buildControl {
    ...
    //Create save button
    _saveButton = [[SHRectangleButton alloc] initWithFrame:CGRectMake(10.0, 10.0, self.frame.size.width-20.0, SAVE_AREA_HEIGHT-20.0)];
