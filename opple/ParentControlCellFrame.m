...
#define textsize 14
#define padding 8
@implementation ParentControlCellFrame
...
-(void)setDeviceInfo:(DeviceInfo *)deviceInfo
{
    ...
    CGSize macSize = [TextUtil getSize:[NSString stringWithFormat:@"mac:%@",self.deviceInfo.MAC] withTextSize: textsize];
    ...
    CGSize nameSize = [TextUtil getSize:[NSString stringWithFormat:@"名称:%@",self.deviceInfo.NAME] withTextSize:textsize];
